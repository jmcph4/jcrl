...
const char* tests[UNIT_SLIST_NUM_TESTS] = {
                                    ...
                                    "test_slist_in_normal",
                                    "test_slist_in_null_params",
                                    "test_slist_in_empty_list",
                                    ...
                                    "test_slist_find_normal",
                                    "test_slist_find_null_params",
                                    "test_slist_find_not_found",
                                    "test_slist_find_empty_list",
                                    "test_slist_find_duplicates"
                                    };
...
int main(void)
{
    ...
    /* Membership */
    results[t] = test_slist_in_normal();
    t++;
    results[t] = test_slist_in_null_params();
    t++;
    results[t] = test_slist_in_empty_list();
    t++;
    ...
    results[t] = test_slist_find_normal();
    t++;
    results[t] = test_slist_find_null_params();
    t++;
    results[t] = test_slist_find_not_found();
    t++;
    results[t] = test_slist_find_empty_list();
    t++;
    results[t] = test_slist_find_duplicates();
    t++;
