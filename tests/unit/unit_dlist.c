...
bool test_dlist_free_normal(void)
{
    ...
    unsigned int res = dlist_free(NULL, &list);
...
bool test_dlist_free_null_params(void)
{
    ...
    unsigned int res = dlist_free(NULL, NULL);
...
bool test_dlist_equal_normal(void)
{
    ...
    dlist_free(NULL, &list_a);
    dlist_free(NULL, &list_b);
...
bool test_dlist_concatenate_normal(void)
{
    ...
    dlist_free(NULL, &list_a);
    dlist_free(NULL, &list_b);
    dlist_free(NULL, &expected_list_concat);
    dlist_free(NULL, &expected_list_b);
...
bool test_dlist_find_normal(void)
{
    ...
    unsigned int res = dlist_find(&pos, (void*)b, &list);
...
bool test_dlist_find_null_params(void)
{
    ...
    unsigned int res = dlist_find(NULL, NULL, NULL);
...
bool test_dlist_find_not_found(void)
{
    ...
    unsigned int res = dlist_find(&pos, (void*)c, &list);
...
bool test_dlist_find_empty_list(void)
{
    ...
    unsigned int res = dlist_find(&pos, (void*)a, &list);
